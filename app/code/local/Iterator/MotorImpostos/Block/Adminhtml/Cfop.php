...
class Iterator_MotorImpostos_Block_Adminhtml_Cfop extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        $this->_blockGroup = 'motorimpostos';
        $this->_controller = 'adminhtml_cfop';
        $this->_headerText = $this->__('Gerenciar CFOP');       
         
        parent::__construct();
        $this->_updateButton('add', 'label', $this->__('Criar CFOP'));
    }
}
?>
