...
class Iterator_MotorImpostos_Block_Adminhtml_Imposto_Padraouf_Edit_Renderer_Padraouf extends Mage_Adminhtml_Block_Widget implements Varien_Data_Form_Element_Renderer_Interface {

    public function __construct() {
        $this->setTemplate('iterator_motorimpostos/padrao_uf.phtml');
    }
