...
class Iterator_MotorImpostos_Block_Adminhtml_Imposto_Simples extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct() {
        ...
        $this->_controller = 'adminhtml_imposto_simples';
     
        $this->_updateButton('save', 'label', $this->__(utf8_encode('Salvar Alíquota SN')));
        if(Mage::registry('aliquota_sn') && Mage::registry('aliquota_sn')->getId() ) {
            ...
            $this->_formScripts[] = "           
                function saveAndContinueEdit(){
                    editForm.submit($('edit_form').action+'back/editAliquota/');
                }
            ";
        }
    }  
