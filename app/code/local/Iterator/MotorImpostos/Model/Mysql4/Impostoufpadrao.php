...
class Iterator_MotorImpostos_Model_Mysql4_ImpostoUfPadrao extends Mage_Core_Model_Mysql4_Abstract {

    protected function _construct()
    {
        $this->_init('motorimpostos/impostoufpadrao', 'padrao_uf_id');
    }
}
