...
function respondToChange(event) {
    ...
    if(elementId === 'aliquota_ir' || elementId === 'aliquota_csll' || elementId === 'aliquota_interestadual' ||
            elementId === 'aliquota_pis' || elementId === 'aliquota_cofins' || elementId === 'aliquota_ipi' || elementId === 'aliquota_ii' || elementId === 'aliquota_iss') {
